...
function TodoList() {
  const [todos, setTodos] = useState<Todo[]>([
    { id: "welcome-task", text: "Welcome to your todo list", completed: false },
  ]);
  ...
  return (
    <div className="min-h-screen bg-[#faf9f6] p-8">
      <div className="w-full max-w-md mt-10  mx-auto bg-[#fffffd] rounded-2xl shadow-md p-4 border border-gray-300 overflow-hidden">
        {/*Header*/}
              ...
              {todos.map((todo) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 shrink-0 h-7 w-7 flex items-center justify-center rounded-md text-gray-5 00 hover:text-red-500 hover:bg-red-50 transition"
                  >
